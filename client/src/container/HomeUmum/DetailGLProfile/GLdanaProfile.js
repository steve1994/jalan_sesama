...
class GLdanaProfile extends React.Component {
            ...
            <Card style={{ height: 480 }}>
              ...
              <Row>
                <CardItem cardBody style={{ margin: 10 }}>
                  <Button transparent light onPress={() => this.props.navigation.navigate("addPantiProfile")} style={{}}>
              ...
              <Row>
                <CardItem cardBody style={{ margin: 10 }} >
                  <Button transparent light onPress={() => this.props.navigation.navigate("addSesamaProfile")} style={{}}>
              ...
              <Row>
                <CardItem cardBody style={{ margin: 10 }}>
                  <Button transparent light onPress={() => { showDetail(idUser); this.props.navigation.navigate("galangKamuProfile") }} >
