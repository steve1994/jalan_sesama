      ...
      <Card style={{ backgroundColor: '#156cb3' }}>
        <Card style={{ height: 315, backgroundColor: '#156cb3' }} >
          <CardItem style={{ justifyContent: "flex-end", height: 48, }}>
            ...
            <Right>
              <Button
                onPress={() => this.props.navigation.navigate("addDonasiProfile")} style={{ margin: 10, backgroundColor: '#268026', width: 80, }}>
                    ...
                    <CardItem style={{ justifyContent: "flex-end" }}>
                      <Right>
                        <Row>
                          ...
                          <Button
                            onPress={() => {this.props.navigation.navigate("DetailGLProfile");{showDetail(item._id, item.type)}}}
