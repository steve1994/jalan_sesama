...
import ListGalang from '../../../container/HomeUmum/DetailGLProfile/ListGalang';


export default class galangKamuPofile extends React.Component {
  ...
  render() {
    ...
    console.log('propsGalangKamu', galangKamu);
